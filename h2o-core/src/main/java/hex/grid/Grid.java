...
public class Grid<MP extends Model.Parameters> extends Lockable<Grid<MP>> {
  ...
  private final MP _params;
    ...
    private static final Key<Model> EMPTY_MODEL_KEY = Key.makeUserHidden("GridSearchFailureEmptyModelKey");
    public final class SearchFailure extends Iced<SearchFailure> {
  ...
  private void appendFailedModelParameters(final Key<Model> modelKey, final MP params, final String[] rawParams,
      ...
      final Key<Model> searchedKey = modelKey != null ? modelKey : EMPTY_MODEL_KEY;
  ...
  public int getModelCount() {
    ...
    public SearchFailure getFailures() {
        ...
        final SearchFailure searchFailure = new SearchFailure();
